...
describe('AVATAR controller', () => {
    ...
    describe("AVATAR GET BY ID", () => {
        test("should get avatar by id successfully", async () => {
            ...
            expect(res.body.avatar.eyes).toBe(2);
            expect(res.body.avatar.earrings).toBe(2);
            expect(res.body.avatar.eyebrows).toBe(2);
            expect(res.body.avatar.features).toBe(2);
            expect(res.body.avatar.hair).toBe(1);
            expect(res.body.avatar.glasses).toBe(1);
            expect(res.body.avatar.mouth).toBe(1);
        });
    });
