...
const priceWeight1 = 1;
const priceWeight2 = 2;
const priceWeight3 = 4;
const priceWeight4 = 8;
...
export default {
    create:       async (req, res, next) => {
        if (!req.body.name) {
            ...
            const newGame = new GameModel({
                ...
                surveyEnabled:           true,
                devMode:                 false,
                priceWeight1:            priceWeight1,
                priceWeight2:            priceWeight2,
                priceWeight3:            priceWeight3,
                priceWeight4:            priceWeight4,
                round:                   0,
                roundMax:                1,
                roundMinutes:            25,
                autoDeath:               true,
    ...
    stopRound:    async (req, res, next) => {
        ...
        body('idGame').trim().escape(), async (req, res, next) => {
            const id = req.body.idGame;
            if (!id) {
                next({
                    status:  400,
