...
let constructor = {
    ...
    feedback: Feedback = (depressedHappy, individualCollective, insatisfiedAccomplished, greedyGenerous, competitiveCooperative, anxiousConfident,
                          agressiveAvenant, irritableTolerant, dependantAutonomous,) => {
        return {
            depressedHappy,
