...
import { sanitize } from './survey.validation.js';

const router = express.Router();

router.get('/:gameStateId/:avatarId', validate(sanitize.getByGameStateIdAndPlayerId, true), surveyController.getByGameStateIdAndPlayerId);
