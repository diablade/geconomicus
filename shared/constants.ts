...
export const DEATH_EVENT_TYPES: readonly string[] = [
...
export function isDeathEvent(typeEvent: string): boolean {
...
export const LK_KEYS = {
	PLAYERS: 'playersLK',
	MASS_MONETARY: 'massMonetaryLK',
	DU: 'duLK',
	ALIVE_COUNT: 'aliveCountLK',
	BANK_INTEREST_EARNED: 'bankInterestEarnedLK',
	BANK_MONEY_LOST: 'bankMoneyLostLK',
	BANK_MONEY_DESTROYED: 'bankMoneyDestroyedLK',
	BANK_GOODS_EARNED: 'bankGoodsEarnedLK',
} as const;

export type LkKey = (typeof LK_KEYS)[keyof typeof LK_KEYS];

const P = LK_KEYS.PLAYERS;
const MM = LK_KEYS.MASS_MONETARY;
const DU = LK_KEYS.DU;
const ALIVE = LK_KEYS.ALIVE_COUNT;
const B_INT = LK_KEYS.BANK_INTEREST_EARNED;
const B_LOST = LK_KEYS.BANK_MONEY_LOST;
const B_DESTROYED = LK_KEYS.BANK_MONEY_DESTROYED;
const B_GOODS = LK_KEYS.BANK_GOODS_EARNED;

export const EVENT_LK_CONTRACT: Record<string, readonly LkKey[]> = {
	...
	[DB_EVENTS.FIRST_DU]: [MM, DU],
	[DB_EVENTS.DISTRIB_DU]: [P, MM, DU],
	[DB_EVENTS.FREE_MONEY]: [P, MM],
	[DB_EVENTS.CREDIT_NEW]: [P, MM],
	[DB_EVENTS.CREDIT_CANCELED]: [P, MM],
	...
	[DB_EVENTS.ACTION_ASSOCIATION]: [P],
	[DB_EVENTS.ACTION_WAR]: [P],
	[DB_EVENTS.ACTION_ONG]: [P],
};

export const EVENT_LK_EXEMPT: readonly string[] = [
	DB_EVENTS.SESSION_STARTED,
	DB_EVENTS.SESSION_ENDED,
